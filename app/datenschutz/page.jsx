            ...
            <div id="WholeText">
                ...
                <div id="Text">
                    <p>Sie können unsere Seite besuchen, ohne Angaben zu Ihrer Person zu machen. Wir speichern lediglich Zugriffsdaten wie z. B. den Namen Ihres Internet Service Providers, die Seite, von der aus Sie uns besuchen oder den Namen der angeforderten Datei. Diese Daten werden ausschließlich zur Verbesserung unseres Angebotes ausgewertet und erlauben keinen Rückschluss auf Ihre Person.
                        ...
                        Wir speichern Ihre Daten, soweit geschäftsnotwendig und im Rahmen des Bundesdatenschutzgesetzes (BDSG 2018) und der EU-Datenschutz-Grundverordnung (DSGVO) zulässig.</p>
                </div>
                <br />
                <div>
                    <br />
                    <h3>Die Datenverarbeitungsprozesse im Einzelnen:</h3>
                </div>
                <br></br>
                <div id="Text">
                    <p>Registrierung
                        ...
                        Die während des Absendevorgangs zusätzlich erhobenen personenbezogenen Daten werden spätestens nach einer Frist von 30 Tagen gelöscht.</p>
                </div>
            </div>
        </Container>
    );
